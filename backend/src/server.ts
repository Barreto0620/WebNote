...
import eventRoutes from './routes/events'; // <-- NOVA LINHA: Importar rotas de eventos

// Carrega variáveis de ambiente
dotenv.config({ path: '.env' }); 

// ADICIONE ESTA LINHA PARA DEBUGAR (mantido conforme sua versão)
...
app.use('/api/events', eventRoutes); // <-- NOVA LINHA: Rotas de eventos
